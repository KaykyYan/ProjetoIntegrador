...
public class TesteBorderLayout extends JFrame {
	public TesteBorderLayout() {
		...
		JButton b2 = criarBotao("Botao Norte", BorderLayout.SOUTH);
		JButton b3 = criarBotao("Botao Norte", BorderLayout.EAST);
		JButton b4 = criarBotao("Botao Norte", BorderLayout.WEST);
		JButton b5 = criarBotao("Botao Norte", BorderLayout.CENTER);
		setVisible(true);
	}
